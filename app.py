...
def index():
    api_list = {
        ...
        "PlaylistSong APIs": {
            ...
            "3. Method GET - Mengambil PlaylistSong berdasarkan ID": "/api/playlistsongs/<id>",
            "4. Method PUT - Memperbarui PlaylistSong berdasarkan ID": "/api/playlistsongs/<id>",
            "5. Method DELETE - Menghapus PlaylistSong berdasarkan ID": "/api/playlistsongs/<id>",
        },
        "Song APIs": {
